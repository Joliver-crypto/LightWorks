...
// Device type enumeration - this will be dynamically populated
// For now, we'll keep the existing types for backward compatibility
export const DeviceTypeEnum = z.enum([
  ...
  'motor.newport.picomotor8812',
  'motor.jankomotor.8812',
  'stage.newport.esp',
  'sensor.generic',
...
// Legacy device type metadata - this will be replaced by the registry system
...
export const DEVICE_TYPE_METADATA: Record<DeviceType, {
  ...
  'motor.newport.picomotor8812': {
    label: 'Picomotor 8812',
    icon: '🔧',
    color: 'bg-cyan-500',
    category: 'motion',
    description: 'Newport Picomotor 8812 precision motor controller'
  },
  'motor.jankomotor.8812': {
    ...
    color: 'bg-cyan-500',
    category: 'motion',
    description: 'Newport Picomotor 8812 with Arduino PH/EN drive'
  },
  'stage.newport.esp': {
